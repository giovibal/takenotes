...
const (
	...
	NotesServiceName = "seqsh.v1.NotesService"
)
...
// NotesServiceClient is a client for the seqsh.v1.NotesService service.
...
// NewNotesServiceClient constructs a client for the seqsh.v1.NotesService service. By default, it
...
// CreateNote calls seqsh.v1.NotesService.CreateNote.
...
// UpdateNote calls seqsh.v1.NotesService.UpdateNote.
...
// DeleteNote calls seqsh.v1.NotesService.DeleteNote.
...
// GetNote calls seqsh.v1.NotesService.GetNote.
...
// SearchNotes calls seqsh.v1.NotesService.SearchNotes.
...
// NotesServiceHandler is an implementation of the seqsh.v1.NotesService service.
...
func NewNotesServiceHandler(svc NotesServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/seqsh.v1.NotesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotesServiceHandler) CreateNote(context.Context, *connect.Request[v1.CreateNoteRequest]) (*connect.Response[v1.CreateNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seqsh.v1.NotesService.CreateNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) UpdateNote(context.Context, *connect.Request[v1.UpdateNoteRequest]) (*connect.Response[v1.UpdateNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seqsh.v1.NotesService.UpdateNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) DeleteNote(context.Context, *connect.Request[v1.DeleteNoteRequest]) (*connect.Response[v1.DeleteNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seqsh.v1.NotesService.DeleteNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) GetNote(context.Context, *connect.Request[v1.GetNoteRequest]) (*connect.Response[v1.GetNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("seqsh.v1.NotesService.GetNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) SearchNotes(context.Context, *connect.Request[v1.SearchNotesRequest], *connect.ServerStream[v1.SearchNotesResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("seqsh.v1.NotesService.SearchNotes is not implemented"))
}
